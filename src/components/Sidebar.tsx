...
const Sidebar = () => {
  ...
  return (
    <>
      {/* Desktop View */}
      <div className="box-content hidden min-h-screen min-w-[210px] flex-col bg-white py-10 pl-2 md:flex md:w-1/5 lg:pl-4" style={{backgroundColor:'#84649b'}}>
  ...
  Contact Management
        ...
        <ul className="flex flex-col gap-5 py-10 font-semibold text-black-400">
          <Link to="/">
