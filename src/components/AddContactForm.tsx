  ...
  return (
    <div className="w-full">
      <form className="mx-auto w-full max-w-xl rounded-lg bg-white p-6 shadow-md">
        ...
        <button
  type="button"
  className={`rounded-md bg-green-600 px-6 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black ${
